        ...
        <>
            ...
            <div id="bscs-section">
                <article id="bscs-article">&emsp;All throughout my life I have had a desire to pursue a career in technology.
                    ...
                    research on various technological topics from time to time. During 2019, I felt it would be best to start
                ...
                <img id="bscs-img" src={"images/aboutImages/BSCS_Degree.png"} alt="BSCS Degree"></img>
            </div><hr></hr>
        </>
    );
}
